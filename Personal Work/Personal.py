...
if __name__ == "__main__":
    if not os.path.exists("/Users/jiweilu/Desktop/zhanglixin"):
            os.mkdir("/Users/jiweilu/Desktop/zhanglixin")       #避免文件重复
    ...
    while(i<20):    #抓取搜索结果前20页文本
        ...
        for elem in elems:
            ...
            if is_class_para('para'):
                ...
                for elem_div in elems_div:
                    #print(elem_div.text)
                    with open('/Users/jiweilu/Desktop/zhanglixin/'+title+'.txt',"a") as f:  #将正文内容写入文件，文件名为链接列表名
        ...
        browser.switch_to.window(browser.window_handles[0])
    '''分析抓取结果'''
    all_file=listdir('/Users/jiweilu/Desktop/zhanglixin')
    for file in all_file:
            if os.path.getsize(os.path.join("/Users/jiweilu/Desktop/zhanglixin", file)) == 0:  #删除空文件
...
corpus=[] #空语料库
'''过滤停用词'''
typetxt=open('/Users/jiweilu/Desktop/zhanglixin/stop.txt')
texts=['\u3000','\n',' '] #爬取的文本中未处理的特殊字符
'''建立停用词库'''
for word in typetxt:
    word=word.strip()
...
for i in range(0,len(all_file)):
    ...
    file_add='/Users/jiweilu/Desktop/zhanglixin/'+ filename
    print(file_add)
...
for i in range(0,10):
    ...
    print('张立新_'+str(i)+':'+str(label_i).decode('string_escape'))
